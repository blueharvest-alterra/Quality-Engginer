...
public class Article extends PageObject {
    ...
    private By articleImageField = By.xpath("//*[@id=\"root\"]/div/div[2]/div[2]/div/form/div[2]/label[2]/input");
    private By articleDescriptionField = By.xpath("//*[@id=\"desc\"]");
    ...
    private By selectAticleEdit = By.xpath("//*[@id=\"root\"]/div/div[2]/div[2]/div/div[2]/table/tbody/tr[1]/td[4]/button");
    private By selectAticleDelate = By.xpath("//*[@id=\"root\"]/div/div[2]/div[2]/div/div[2]/table/tbody/tr[8]/td[4]/button");
    private By selectAticleView = By.xpath("//*[@id=\"root\"]/div/div[2]/div[2]/div/div[2]/table/tbody/tr[4]/td[4]/button");
    private By viewDetailArticleButton = By.xpath("//*[@id=\"root\"]/div/div[2]/div[2]/div/div[2]/table/tbody/tr[4]/td[4]/div/div/a[1]/button");
    ...
    public boolean isArticleDetailsPageTextEquals() {
        return $(articleDetailsPageTitle).getText().equals("Artikel");
    }
